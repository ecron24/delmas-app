-- ============================================
-- MIGRATION CORRIGÉE V3: Compléter le schéma de toutes les tables auxiliaires
-- Date: 2025-11-07 (Version 3 - Correction conflit de noms)
...
-- ============================================
-- VÉRIFICATION (CORRIGÉE - conflit de noms résolu)
-- ============================================

DO $$
DECLARE
    v_table_name TEXT;  -- ✅ Variable renommée pour éviter le conflit
    column_count INT;
...
BEGIN
    ...
    LOOP
        ...
        WHERE table_schema = 'piscine_delmas_public'
        AND table_name = v_table_name;  -- ✅ Utilise la variable renommée

        RAISE NOTICE '✅ % : % colonnes', RPAD(v_table_name, 30), column_count;
    END LOOP;
